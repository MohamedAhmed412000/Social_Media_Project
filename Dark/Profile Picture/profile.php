        ...
        <div class="Main">
            <div Class="Orange1">
                ...
                <form action="../search.php">
                    <input class="Search" style="background-color:#121212;" type="text" name="names" width="500px" placeholder="     Search here ...">
                    <input class="SearchIcon" type="image" name="Search" src="../Icons/Search.png" title="search">
                </form>
                <div class="Profile">
                    <a href="../Profile Picture/profile.php">
                        <img class="PP" src="../Icons/Default-Profile-Picture1.png" title="Default Profile Picture" style="width:60px;height:60px;top:0px;">
                    </a>
                    <a class="User" href="profile.php"style="color:#121212;"><?php echo "". $_SESSION['username']; ?></a>
                    <a class="Log" href="../Login and register/Logout.php" style="color:#121212;">Log out</a>
                </div>
            </div>
            <div class="Orange2">
                <div class="Icons">
                ...
                <div class="ChangeTheme">
                    <!-- Rounded switch -->
                    <label class="Text" style="color:#121212;">Light Mode</label>
                    <button class="BTN" onclick="change()" style="background-color:#121212;color:#A3a3a3;">Switch to Light Theme</button>
                </div>
            </div>
            <div class="AddPost">
            ...
            <div class="Gray"></div>
            <div class="new-body">
                <div class="inform" style="background-color:#2d2d2d;">
                    <span class="profile-photo"><img src="../Icons/Default Profile in Posts.png" /></span>
                    <div class="profile-name" style="color:#a3a3a3;"><?php echo "".get_user_name($current_id, $db); ?></div>
                    <div class="study"style="color:#a3a3a3;"><span><img src="../Icons/Education.svg"width="20"height="20"/></span> Faculty Of Engineering Ain Shams</div>
                    <div class="work"style="color:#a3a3a3;"><span> <img src="../Icons/Job.svg"width="20"height="20"/></span> Frontend Devolper</div>
                    <?php
                ...
                <div class="stories">
                 <ul style="background-color:#2d2d2d;">
                        <li>
                            <button class="press">
                            <div class="story">
