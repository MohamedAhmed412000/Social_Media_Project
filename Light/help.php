...
<html>
    <head>
        ...
        <link rel="stylesheet" href="Home Page/LightStyle.css">
        ...
        <div class="Main">
            ...
            <div class="change">
                <div class="help" style="text-align: center;">
                    <h2 style="margin-top: 30px; color: #000000;">Add post</h2>
                    ...
                    <h2 style="margin-top: 30px; color: #000000;">Search</h2>
                    ...
                    <h2 style="margin-top: 30px; color: #000000;">Add friends</h2>
                    ...
                    <h2 style="margin-top: 30px; color: #000000;">Delete friends</h2>
                    ...
                    <h2 style="margin-top: 30px; color: #000000;">Add to mention list</h2>
                    ...
                    <h2 style="margin-top: 30px; color: #000000;">Add comment and mention</h2>
                    ...
                    <h2 style="margin-top: 30px; color: #000000;">Save and share posts</h2>
                    ...
                    <h2 style="margin-top: 30px; color: #000000;">FAQ</h2>
