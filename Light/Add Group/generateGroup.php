...
<script>
        ...
        function change(){
                var url = "../../Dark/Add Group/generateGroup.php";
                window.location = url;
            }
        function Un_Join(){
...
<html>
    <head>
        ...
        <title>Group</title>
        <link rel="stylesheet"href="generateGroup7.css">
        <link rel="icon" href="../Icons/Groups1.png">
    </head>
    <body>
    <div class="Main">
    <div Class="Orange1">
        ...
        <div class="change" style="overflow-y:auto;position: absolute;top: 50px;left: 260px;">
            <div style="top: 10px;left: 15px; background-color: white;width:800px;height:245px;border-radius:30px;position: relative;">
                    ...
                    <a style="position:absolute;top: 30px;left: 250px;padding: 5px;font-size: 30px;font-weight: bold;color: black;text-decoration: none;" href="../Group/LightGroup.php"><?php  echo $_SESSION['groupname']; ?></a><!--no word exceed 16 letters and no page name exceeds two lines -->
                    <br><br>
                    <div style="position: absolute;left: 255px;top: 95px;width:150px;">
                        <div class="type"><img src="../Icons/type.png"width="18"height="18" title="Group Type"> <?php echo $_SESSION['grouptype']; ?></div><br>
                        <div class="admin"><img src="../Icons/admin.png"width="18"height="18" title="Admin Name" style="display:Inline;"> <?php echo $_SESSION['groupadmin']; ?></div>
                    </div>
                    ...
                    <?php if($_SESSION['Joining'] == 1){ ?>
                        <img id="Join" class="like" src="../Icons/Add.png"width="26"height="26" alt="">
                    <?php }else{?>
                            <img id="Join" class="like" src="../Icons/Add1.png"width="26"height="26" alt="">
                    <?php }?>
                    </button>
        ...
        <div id="posts">
                <?php foreach($result as $one){ ?>
                    <section class="post" style="overflow:hidden;padding: 20px;font-size: 30px;align-items: center;justify-content: center;top: 350px;left:270px;grid-area: name;position: relative;background-color: white;margin: 10px;border: 1px solid white;border-radius: 30px;width: 760px;height: 350px;font-size: 30px;align-items: center;position: relative;">
                        ...
                        <div class="head" style = "color: black;position: absolute;left: 130px;top: 40px;font-size: 30px;"><?php echo $one['post_user']; ?></div>
