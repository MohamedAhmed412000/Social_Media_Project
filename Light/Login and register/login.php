            ...
            <div class="sign-in-up-container">
                <form class="sign-in-form" method="post" action="<?php $_SERVER['PHP_SELF'];?>">
                    <?php include('errors.php'); ?>
                        ...
                        <button type="submit" class="sign-in" name="login_user">Log in</button>
                        <br>
                        <br>
                        <br>
                        <br>
                    <span>Dosn't have an account?</span>
                    <button type="button" class="sign-up"><a style = "text-decoration: none;" href="register.php">Sign up</a></button>
                    <br>
                    <br>
                    </form>
                </div>
