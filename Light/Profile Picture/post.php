<?php
	$output = '<section class="post" style="padding: 20px;font-size: 30px;align-items: center;justify-content: center;margin-top: auto;grid-area: name;position: relative;background: white;
    margin: 10px;
  ...
  padding: 20px;
    ...
    margin-right: 10px;
    font-size: 25px;
    color: black;">' . $row['post_caption'] . '</p>
    ...
    width: 100px;"><img id="Pes" src="../Icons/Pes Unpressed.png" alt="" style="position: absolute;
     ...
     background-color: white;"></button>
                    ...
                    <button class="share" style="border-top: 4px solid #d8d7d6;
    grid-area: share;
    padding: 5px;
    height: 116px;
    ...
    <input type="submit" name="comm" value="Discuss" style="width: 100px; height: 80px; position: absolute;right:100px ;top:230px; border-radius:0px 0px 40px 0px; background-color:white; color:#A3a3a3; ">
                    </form>
                </section>';
    echo $output;
?>  
